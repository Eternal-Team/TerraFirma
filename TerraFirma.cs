...
namespace TerraFirma
{
	...
	public class TerraFirma : Mod
	{
		public override void Load()
		{
			...
			Main.graphics.PreparingDeviceSettings += Graphics_PreparingDeviceSettings;
		}
		...
		private void Main_DrawPlayer_DrawAllLayers(On.Terraria.Main.orig_DrawPlayer_DrawAllLayers orig, Main self, Player drawPlayer, int projectileDrawPosition, int cHead)
		{
			try
			{
				...
				Main.spriteBatch.Begin();
				Main.spriteBatch.Draw(target, new Vector2(Main.screenWidth, Main.screenHeight) * (0f), null, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			}
			catch
			{
